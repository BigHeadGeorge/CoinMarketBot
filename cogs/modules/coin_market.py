...
class CoinMarket:
    ...
    def get_currency(self, market_list, acronym_list, currency, fiat):
        """
    ...
    def get_stats(self, market_stats, fiat):
        """
    ...
    def get_multiple_currency(self, market_list, acronym_list, currency_list, fiat, cached_data=None):
        """
